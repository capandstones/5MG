...
public class SokchoFoodListPanel extends JPanel {

	private Cart cart;
	private CartPanel cartPanel;

	public SokchoFoodListPanel() {
		...
		ImageIcon smap = new ImageIcon("속초.jpg");
		...
		// 하단의 버튼 설정
		JButton hbtn1 = new JButton("속초 신토불이 감자옹심이");
		JButton hbtn2 = new JButton("성진활어");
		JButton hbtn3 = new JButton("키친온유");
		JButton hbtn4 = new JButton("장홍김밥");
		JButton hbtn5 = new JButton("문어랑 속초본점");
		...
		ImageIcon food1 = new ImageIcon("속초_맛집1(속초신토불이감자옹심이).png");
		Image fimg1 = food1.getImage();
		ImageIcon food2 = new ImageIcon("속초_맛집2(성진활어).png");
		Image fimg2 = food2.getImage();
		ImageIcon food3 = new ImageIcon("속초_맛집3(키친온유).png");
		Image fimg3 = food3.getImage();
		ImageIcon food4 = new ImageIcon("속초_맛집4(장홍김밥).png");
		Image fimg4 = food4.getImage();
		ImageIcon food5 = new ImageIcon("속초_맛집5(문어랑속초본점).png");
