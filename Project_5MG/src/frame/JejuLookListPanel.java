...
public class JejuLookListPanel extends JPanel {

	private Cart cart;
	private CartPanel cartPanel;

	public JejuLookListPanel() {
		...
		ImageIcon cinema = new ImageIcon("제주.jpg");
		...
		JButton hbtn1 = new JButton("성산일출봉");
		JButton hbtn2 = new JButton("아르떼");
		JButton hbtn3 = new JButton("우도");
		JButton hbtn4 = new JButton("천지연폭포");
		JButton hbtn5 = new JButton("카멜리아힐");
		...
		ImageIcon look1 = new ImageIcon("제주_관광지1(성산일출봉1).jpg");
		Image limg1 = look1.getImage();
		ImageIcon look2 = new ImageIcon("제주_관광지2(아르떼1).jpg");
		Image limg2 = look2.getImage();
		ImageIcon look3 = new ImageIcon("제주_관광지3(우도1).jpg");
		Image limg3 = look3.getImage();
		ImageIcon look4 = new ImageIcon("제주_관광지4(천지연폭포1).jpg");
		Image limg4 = look4.getImage();
		ImageIcon look5 = new ImageIcon("제주_관광지5(카멜리아힐1).jpg");
