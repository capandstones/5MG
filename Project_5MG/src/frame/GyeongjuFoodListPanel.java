...
public class GyeongjuFoodListPanel extends JPanel {

	private Cart cart;
	private CartPanel cartPanel;

	public GyeongjuFoodListPanel() {
		...
		JButton hbtn1 = new JButton("남정부일기사식당");
		JButton hbtn2 = new JButton("양지식당");
		JButton hbtn3 = new JButton("빼돌린뒷고기");
		JButton hbtn4 = new JButton("황남경추식당");
		JButton hbtn5 = new JButton("카페 바실라");
		...
		ImageIcon food1 = new ImageIcon("경주_맛집1(남정부일기사식당1).jpeg");
		Image fimg1 = food1.getImage();
		ImageIcon food2 = new ImageIcon("경주_맛집2(양지식당1).png");
		Image fimg2 = food2.getImage();
		ImageIcon food3 = new ImageIcon("경주_맛집3(뺴돌린뒷고기1).png");
		Image fimg3 = food3.getImage();
		ImageIcon food4 = new ImageIcon("경주_맛집4(황남경주식당1).png");
		Image fimg4 = food4.getImage();
		ImageIcon food5 = new ImageIcon("경주_맛집5(카페 바실라1).jpg");
