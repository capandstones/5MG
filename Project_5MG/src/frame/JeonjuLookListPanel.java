...
public class JeonjuLookListPanel extends JPanel {

	private Cart cart;
	private CartPanel cartPanel;

	public JeonjuLookListPanel() {
		...
		// 하단의 버튼 설정
		JButton hbtn1 = new JButton("한옥 마을");
		JButton hbtn2 = new JButton("경기전");
		JButton hbtn3 = new JButton("객리단길");
		JButton hbtn4 = new JButton("수목원");
		JButton hbtn5 = new JButton("덕진 공원");
		...
		ImageIcon look1 = new ImageIcon("전주_여행지1(한옥마을).jpg");
		Image limg1 = look1.getImage();
		ImageIcon look2 = new ImageIcon("전주_여행지2(경기전).jpg");
		Image limg2 = look2.getImage();
		ImageIcon look3 = new ImageIcon("전주_여행지3(객리단길(객사길)).jpg");
		Image limg3 = look3.getImage();
		ImageIcon look4 = new ImageIcon("전주_여행지4(수목원).jpg");
		Image limg4 = look4.getImage();
		ImageIcon look5 = new ImageIcon("전주_여행지5(덕진 공원).jpg");
