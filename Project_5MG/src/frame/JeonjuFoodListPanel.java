...
public class JeonjuFoodListPanel extends JPanel {

	private Cart cart;
	private CartPanel cartPanel;

	public JeonjuFoodListPanel() {
		...
		ImageIcon smap = new ImageIcon("전주.jpg");
		...
		// 하단의 버튼 설정
		JButton hbtn1 = new JButton("메르밀진미집");
		JButton hbtn2 = new JButton("진미집");
		JButton hbtn3 = new JButton("카페 전망");
		JButton hbtn4 = new JButton("한방 오리촌");
		JButton hbtn5 = new JButton("황제보쌈");
		...
		ImageIcon food1 = new ImageIcon("전주_맛집1(메르밀진미집).jpg");
		Image fimg1 = food1.getImage();
		ImageIcon food2 = new ImageIcon("전주_맛집2(진미집).jpg");
		Image fimg2 = food2.getImage();
		ImageIcon food3 = new ImageIcon("전주_맛집3(카페 전망).jpg");
		Image fimg3 = food3.getImage();
		ImageIcon food4 = new ImageIcon("전주_맛집4(한방 오리촌).jpg");
		Image fimg4 = food4.getImage();
		ImageIcon food5 = new ImageIcon("전주_맛집5(황제보쌈).jpg");
