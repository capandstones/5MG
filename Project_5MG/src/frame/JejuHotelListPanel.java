...
public class JejuHotelListPanel extends JPanel {

	private Cart cart;
	private CartPanel cartPanel;

	public JejuHotelListPanel() {
		...
		// 하단의 버튼 설정
		JButton hbtn1 = new JButton("성산플로우");
		JButton hbtn2 = new JButton("마레보비치호텔");
		JButton hbtn3 = new JButton("달그리안");
		JButton hbtn4 = new JButton("브릿지");
		JButton hbtn5 = new JButton("디 아넥스");
		...
		ImageIcon look1 = new ImageIcon("제주_숙박1(성산플로우1).jpg");
		Image limg1 = look1.getImage();
		ImageIcon look2 = new ImageIcon("제주_숙박2(마레보비치호텔1).jpg");
		Image limg2 = look2.getImage();
		ImageIcon look3 = new ImageIcon("제주_숙박3(달그리안1).PNG");
		Image limg3 = look3.getImage();
		ImageIcon look4 = new ImageIcon("제주_숙박4(브릿지1).jpg");
		Image limg4 = look4.getImage();
		ImageIcon look5 = new ImageIcon("제주_숙박5(디 아넥스1).jpg");
