...
public class SokchoHotelListPanel extends JPanel {

	private Cart cart;
	private CartPanel cartPanel;

	public SokchoHotelListPanel() {
		...
		ImageIcon cinema = new ImageIcon("속초.jpg");
		...
		JLabel titleLabel = new JLabel("속초");
		...
		lookbnt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FrameBase.getDispose();
				FrameBase.getInstance(new SokchoLookListPanel());
				setVisible(false);
		...
		hotelbnt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FrameBase.getDispose();
				FrameBase.getInstance(new SokchoHotelListPanel());
				setVisible(false);
		...
		// 하단의 버튼 설정
		JButton hbtn1 = new JButton("더마크 속초 레지던스 호텔");
		JButton hbtn2 = new JButton("씨크루즈 호텔");
		JButton hbtn3 = new JButton("마레몬스 호텔");
		JButton hbtn4 = new JButton("속초 라마다 호텔");
		JButton hbtn5 = new JButton("롯데리조트 속초");
		...
		ImageIcon look1 = new ImageIcon("속초_숙박1(더마크 속초 레지던스 호텔).png");
		Image limg1 = look1.getImage();
		ImageIcon look2 = new ImageIcon("속초_숙박2(씨크루즈 호텔).png");
		Image limg2 = look2.getImage();
		ImageIcon look3 = new ImageIcon("제주_숙박4(브릿지4).jpg");
		Image limg3 = look3.getImage();
		ImageIcon look4 = new ImageIcon("속초_숙박4(속초 라마다 호텔).png");
		Image limg4 = look4.getImage();
		ImageIcon look5 = new ImageIcon("속초_숙박5(롯데리조트 속초).png");
		...
		hbtn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FrameBase.getDispose();
				FrameBase.getInstance(new SokchoHotelDetailPage1("더마크 속초 레지던스 호텔"));
				setVisible(false);
			}
		});
		...
		hbtn3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FrameBase.getDispose();
				FrameBase.getInstance(new SokchoHotelDetailPage3("마레몬스"));
				setVisible(false);
			}
		});
		...
		hbtn4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FrameBase.getDispose();
				FrameBase.getInstance(new SokchoHotelDetailPage4("속초 라마다 호텔"));
				setVisible(false);
			}
		});
