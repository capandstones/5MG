...
public class JeonjuHotelListPanel extends JPanel {

	private Cart cart;
	private CartPanel cartPanel;

	public JeonjuHotelListPanel() {
		...
		ImageIcon cinema = new ImageIcon("전주.jpg");
		...
		JLabel titleLabel = new JLabel("전주");
		...
		// 하단의 버튼 설정
		JButton hbtn1 = new JButton("호텔 다빈");
		JButton hbtn2 = new JButton("더 빈센트");
		JButton hbtn3 = new JButton("블루 보트 호텔");
		JButton hbtn4 = new JButton("더 클래식 호텔");
		JButton hbtn5 = new JButton("라온 한옥 꿀잠");
		...
		ImageIcon look1 = new ImageIcon("전주_숙박1(호텔 다빈).jpg");
		Image limg1 = look1.getImage();
		ImageIcon look2 = new ImageIcon("전주_숙박2(더 빈센트).jpg");
		Image limg2 = look2.getImage();
		ImageIcon look3 = new ImageIcon("전주_숙박3(블루 보트 호텔).jpg");
		Image limg3 = look3.getImage();
		ImageIcon look4 = new ImageIcon("전주_숙박4(더 클래식 호텔).jpg");
		Image limg4 = look4.getImage();
		ImageIcon look5 = new ImageIcon("전주_숙박5(라온 한옥 꿀잠).jpg");
		...
		hbtn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FrameBase.getDispose();
				FrameBase.getInstance(new JeonjuHotelDetailPage1("호텔 다빈"));
				setVisible(false);
			}
		});
		...
		hbtn3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FrameBase.getDispose();
				FrameBase.getInstance(new JeonjuHotelDetailPage3("블루 보트 호텔"));
				setVisible(false);
			}
		});
