...
public class SokchoLookListPanel extends JPanel {

	private Cart cart;
	private CartPanel cartPanel;

	public SokchoLookListPanel() {
		...
		JLabel hotelLabel = new JLabel("관광지");
		hotelLabel.setFont(new Font("여기어때 잘난체", Font.BOLD, 25));
		hotelLabel.setSize(100, 50);
		hotelLabel.setLocation(75, 460);

		// 하단의 버튼 설정
		JButton hbtn1 = new JButton("속초 아이 대관람차");
		JButton hbtn2 = new JButton("설악 케이블카");
		JButton hbtn3 = new JButton("아바이 마을");
		JButton hbtn4 = new JButton("영금정");
		JButton hbtn5 = new JButton("테디베어팜");
		...
		ImageIcon look1 = new ImageIcon("속초_관광지1(속초아이대관람차).png");
		Image limg1 = look1.getImage();
		ImageIcon look2 = new ImageIcon("속초_관광지2(설악케이블카).png");
		Image limg2 = look2.getImage();
		ImageIcon look3 = new ImageIcon("속초_관광지3(아바이마을).png");
		Image limg3 = look3.getImage();
		ImageIcon look4 = new ImageIcon("속초_관광지4(영금정).png");
		Image limg4 = look4.getImage();
		ImageIcon look5 = new ImageIcon("속초_관광지5(테디베어팜).png");
