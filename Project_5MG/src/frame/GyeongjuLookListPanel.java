...
public class GyeongjuLookListPanel extends JPanel {
	private Cart cart;
	private CartPanel cartPanel;

	public GyeongjuLookListPanel() {
		...
		// 하단의 버튼 설정
		JButton hbtn1 = new JButton("불국사");
		JButton hbtn2 = new JButton("월정교");
		JButton hbtn3 = new JButton("첨성대");
		JButton hbtn4 = new JButton("둥궁과월지");
		JButton hbtn5 = new JButton("양동마을");
		...
		ImageIcon look1 = new ImageIcon("경주_관광지1(불국사1).jpg");
		Image limg1 = look1.getImage();
		ImageIcon look2 = new ImageIcon("경주_관광지2(월정교1).jpg");
		Image limg2 = look2.getImage();
		ImageIcon look3 = new ImageIcon("경주_관광지3(첨성대1).jpg");
		Image limg3 = look3.getImage();
		ImageIcon look4 = new ImageIcon("경주_관광지4(동궁과월지1).jpg");
		Image limg4 = look4.getImage();
		ImageIcon look5 = new ImageIcon("경주_관광지5(양동마을1).jpg");
